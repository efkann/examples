    ...
    <Page>
      <section className="flex flex-col gap-6">
        ...
        <Text>
          ...
          from clients to change behavior or pass data to API Routes or <Code>getServerSideProps</Code>.
          To modify to the request headers specify the new headers
          (see <Link href="https://developer.mozilla.org/en-US/docs/Web/API/Headers">Headers API</Link>)
          in {' '} <Code>request.headers</Code> parameter of{' '}
          <Code>NextResponse.next()</Code> or <Code>NextResponse.rewrite()</Code>.
        </Text>
        <Snippet>
...
`}
      ...
      <section className="flex flex-col items-center gap-3">
        <Text>Request Headers in <Code>getServerSideProps</Code>:</Text>
        <Console>
          <p>
